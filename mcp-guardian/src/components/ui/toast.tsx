  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        "border-colors-border-subtle bg-colors-bg-surface",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "border-colors-border-subtle bg-colors-bg-interactive hover:bg-colors-bg-interactive/80 text-colors-text-primary",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      ...
      "text-colors-text-primary hover:text-colors-text-secondary",
      className
    )}
    toast-close=""
    {...props}
