...
export interface GuardProfileInputRepresentationNodeData extends GuardProfileNodeData {
  type: "Input";
}

export interface GuardProfileInputRepresentationNode extends Node {
  type: "Input";
  data: GuardProfileInputRepresentationNodeData;
}

export interface GuardProfileInputRepresentationNodeProps extends NodeProps {
  data: GuardProfileInputRepresentationNodeData;
}

// Input node represents incoming messages from MCP servers
const InputRepresentationNode = ({ selected }: GuardProfileInputRepresentationNodeProps) => {
  return (
    <div
      className={`node input-node rounded-lg border p-3 bg-background shadow-sm ${
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          ...
          <div className="text-xs text-muted-foreground">Incoming messages</div>
        </div>
      </div>
...
export default InputRepresentationNode;
