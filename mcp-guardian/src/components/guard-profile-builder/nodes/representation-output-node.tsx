...
export interface GuardProfileOutputRepresentationNodeData extends GuardProfileNodeData {
  type: "Output";
}

export interface GuardProfileOutputRepresentationNode extends Node {
  type: "Output";
  data: GuardProfileOutputRepresentationNodeData;
}

export interface GuardProfileOutputRepresentationNodeProps extends NodeProps {
  data: GuardProfileOutputRepresentationNodeData;
}

// Output node represents processed messages being delivered to the application
const OutputRepresentationNode = ({ selected }: GuardProfileOutputRepresentationNodeProps) => {
  return (
    <div
      className={`node output-node rounded-lg border p-3 bg-background shadow-sm ${
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          ...
          <div className="text-xs text-muted-foreground">Processed messages</div>
        </div>
      </div>
    </div>
  );
...
export default OutputRepresentationNode;
