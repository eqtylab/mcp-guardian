...
// Extended message log node data with UI state
interface ExtendedMessageLogNodeData extends MessageLogNodeData {
  isExpanded?: boolean;
  onToggleExpand?: (nodeId: string) => void;
}

// Use NodeProps from ReactFlow - fixed for proper type compatibility
const MessageLogNode = ({ data, selected, id }: NodeProps) => {
  // Get the data - handle it gracefully if it's invalid
  const extendedData = data as ExtendedMessageLogNodeData;
  const currentLogLevel = extendedData?.log_level || 'Info';
  
  // Use expanded state from props instead of local state
  const expanded = extendedData.isExpanded || false;
  ...
  const getLogLevelDescription = (level: string): string => {
    switch (level) {
      case 'Error': return 'Critical errors only';
      case 'Warn': return 'Warnings and errors';
      case 'Info': return 'General information (default)';
      case 'Debug': return 'Detailed information for debugging';
      case 'Trace': return 'Very verbose with all details';
  ...
  return (
    <div 
      className={`node messagelog-node rounded-lg border p-3 shadow-md cursor-move ${
        ...
        selected ? 'border-primary ring-2 ring-primary/20 bg-cyan-950/5 dark:bg-cyan-800/10' : 'border-muted bg-card dark:bg-cyan-950/5'
      }`}
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <span className={`font-medium ${getLogLevelColor(currentLogLevel)}`}>
                {currentLogLevel}
              </span>
            </div>
          </div>
        ...
        <button 
          ...
          onClick={(e) => {
            e.stopPropagation();
            if (extendedData.onToggleExpand) {
              extendedData.onToggleExpand(id);
            }
          }}
          ...
          <div className="grid grid-cols-1 gap-y-3">
              ...
              <div className="grid grid-cols-1 gap-1">
                ...
                >
                  <div className="flex items-center gap-1">
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-red-500">
                      <circle cx="12" cy="12" r="10"></circle>
                      <line x1="12" y1="8" x2="12" y2="12"></line>
                      <line x1="12" y1="16" x2="12.01" y2="16"></line>
                    </svg>
                ...
                >
                  <div className="flex items-center gap-1">
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-orange-500">
                      <path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"></path>
                      <line x1="12" y1="9" x2="12" y2="13"></line>
                      <line x1="12" y1="17" x2="12.01" y2="17"></line>
                    </svg>
                ...
                >
                  <div className="flex items-center gap-1">
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-500">
                      <circle cx="12" cy="12" r="10"></circle>
                      <line x1="12" y1="16" x2="12" y2="12"></line>
                      <line x1="12" y1="8" x2="12.01" y2="8"></line>
                    </svg>
                ...
                >
                  <div className="flex items-center gap-1">
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-purple-500">
                      <path d="M7 12a5 5 0 0 1 5-5v0a5 5 0 0 1 5 5v0"></path>
                      <path d="M12 7v1"></path>
                      <path d="M7 7v1"></path>
                      <path d="M17 7v1"></path>
                ...
                >
                  <div className="flex items-center gap-1">
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-slate-500">
                      <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
                      <polyline points="22 4 12 14.01 9 11.01"></polyline>
                    </svg>
                    <span>Trace</span>
            ...
            <div className="grid grid-cols-1 gap-2 p-2 border border-cyan-200 dark:border-cyan-900/50 bg-cyan-50/30 dark:bg-cyan-900/20 rounded-md">
              ...
              <div className="text-[10px] text-muted-foreground mt-1">
                Higher levels (like Error) include fewer messages, while lower levels (like Trace) include more verbose output.
              </div>
            </div>
          </div>
        </div>
